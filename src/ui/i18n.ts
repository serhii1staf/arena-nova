...
const STRINGS = {
  en: {
    ...
    'gather.take': 'E — take',
    'gather.fell': 'E — fell it',
    'gather.needAxe': 'An axe is needed',
    'gather.bench': 'E — workbench',

    'inv.bag': 'Bag',
    'inv.craft': 'Crafting',
    'inv.empty': 'Nothing yet. Sticks and stones are lying about — press E at them.',
    'inv.hand': 'by hand',
    'inv.bench': 'bench',
    'inv.needBench': 'needs a bench',
    'inv.atBench': 'At a workbench — everything is available.',
    'inv.noBench': 'Away from a bench. Find one, or carry your own.',
    'inv.close': 'I to close',
    'inv.eat': 'click to eat',
    'inv.place': 'click to put down',
    'inv.health': 'Health',
    'inv.water': 'Water',
    'inv.food': 'Food',
  ...
  ru: {
    ...
    'build.cat.interior': 'Интерьер',
    'build.chair': 'Стул',
    'build.bench': 'Скамья',
    'build.chest': 'Сундук',
    'build.crate': 'Ящик',
    'build.rug': 'Ковёр',
    'build.planter': 'Грядка',
    'build.bed': 'Кровать',
    'build.table': 'Стол',
    'build.stool': 'Табурет',
    'build.cabinet': 'Шкаф',
    ...
    'item.axe': 'Топор',
    'item.pickaxe': 'Кирка',
    'item.workbench': 'Верстак',

    'gather.take': 'E — взять',
    'gather.fell': 'E — срубить',
    'gather.needAxe': 'Нужен топор',
    'gather.bench': 'E — верстак',

    'inv.bag': 'Сумка',
    'inv.craft': 'Крафт',
    'inv.empty': 'Пока пусто. Палки и камни лежат по земле — нажми на них E.',
    'inv.hand': 'руками',
    'inv.bench': 'верстак',
    'inv.needBench': 'нужен верстак',
    'inv.atBench': 'У верстака — доступно всё.',
    'inv.noBench': 'Вдали от верстака. Найди его или носи свой.',
    'inv.close': 'I — закрыть',
    'inv.eat': 'щёлкни, чтобы съесть',
    'inv.place': 'щёлкни, чтобы поставить',
    'inv.health': 'Здоровье',
    'inv.water': 'Вода',
    'inv.food': 'Еда',
